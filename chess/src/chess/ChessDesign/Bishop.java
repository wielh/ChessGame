...
public class Bishop extends ChessBCQ {

    public Bishop(ChessBoard b, Camp c) {
        this.board = b;
        this.camp = c;
    ...
    public final void printChess() {
        ...
        try {
            ...
            if (this.camp == Camp.White && lloc % 2 == 1) {
                s = "src\\img\\WhiteBishopInWhite.png";
            } else if (this.camp == Camp.White && lloc % 2 == 0) {
                s = "src\\img\\WhiteBishopInBlack.png";
            } else if (this.camp == Camp.black && lloc % 2 == 1) {
                s = "src\\img\\BlackBishopInWhite.png";
            } else if (this.camp == Camp.black && lloc % 2 == 0) {
                s = "src\\img\\BlackBishopInBlack.png";
            }
